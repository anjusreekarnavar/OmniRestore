...
from architecture.model_decoder import Decoder
from util import misc
from architecture import model_encoder
#from torch.utils.tensorboard import SummaryWriter
from tensorboardX import SummaryWriter
from engine_model import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--downsampling_factor', default=4, type=int,
                        help='downsampling')
    parser.add_argument('--mask_ratio', default=0.25, type=int,
                        help='masking')
    ...
    parser.add_argument('--enlr', type=float, default=1e-3, metavar='LR',
    ...
    parser.add_argument('--blri', type=float, default=1.5e-5, metavar='LR',
                        help='base learning rate: absolute_lr = base_lr * total_batch_size / 256')#previous value 1e-3
    ...
    parser.add_argument('--output_dir', default='/scratch3/ven073/decoder_shared',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/scratch3/ven073/decoder_shared/log_dir',
...
def main(args):
    ...
    # define the encoder
    path='/home/ven073/anju/dmae2/dmae_base_sigma_0.25_mask_0.75_1100e.pth'
    shared_encoder = model_encoder.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
    pretrained_path = torch.load(path)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if noise_flag==0 or blur_flag==0 or super_flag==0 or inpaint_flag==0 or mask_flag==0:
            encoder,flags = train_one_epoch(shared_encoder,decoders,data_loader_train,data_loader_val,
            device,optimizers,loss_scaler1,loss_scaler2,
            loss_scaler3,loss_scaler4,loss_scaler5,epoch,flags,log_writer,
        ...
        if args.output_dir and (epoch % 20 == 0 or epoch + 1 == args.epochs):  
                ...
                }, f'/scratch3/ven073/decoder_shared/shared_encoder_{epoch+1}.pth')
