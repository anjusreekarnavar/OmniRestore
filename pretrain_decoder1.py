...
from engine_decoder1 import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/scratch3/ven073/decoder1',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/scratch3/ven073/decoder1/log_dir',
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % 100 == 0 or epoch + 1 == args.epochs):
                ...
                }, f'/scratch3/ven073/decoder1/shared_encoder_{epoch+1}.pth')
