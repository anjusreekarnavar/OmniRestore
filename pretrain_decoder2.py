...
from engine_decoder2 import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/scratch3/ven073/decoder2',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/scratch3/ven073/decoder2/log_dir',
...
def main(args):
    ...
    model=Model_Restoration_Decoder2(shared_encoder,decoder)
    model.to(device)
