...
from stage3_engine2ddp import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/scratch3/ven073/dcnn_output2ddp',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/scratch3/ven073/dcnn_output2ddp/log_dir',
