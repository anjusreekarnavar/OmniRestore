...
def get_args_parser():
    ...
    parser.add_argument("--decoder_depth", default=10, type=int, help="dataset path")
    parser.add_argument("--decoder_depth2", default=16, type=int, help="dataset path")
    ...
    parser.add_argument(
        "--num_experts", default=5, type=int, metavar="N", help="number of experts"
    )
