...
def create_dataset_train(dataset_opt,args):
    ...
    data_loader_train = {
    'denoising': DataLoader(dataset_noise_train,sampler=create_sampler_train(dataset_noise_train), batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=True,),
    'deblurring': DataLoader(dataset_blur_train, sampler=create_sampler_train(dataset_blur_train), batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=True,),
    'super_resolution': DataLoader(dataset_super_train, sampler=create_sampler_train(dataset_super_train), batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=True,),
    'inpainting': DataLoader(dataset_inpaint_train, sampler=create_sampler_train(dataset_inpaint_train), batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=True,),
    'demasking': DataLoader(dataset_demask_train,sampler=create_sampler_train(dataset_demask_train), batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=True,),
}
...
def create_dataset_val(dataset_opt,args):
    ...
    data_loader_val = {
    'denoising': DataLoader(dataset_noise_val,sampler=create_sampler_val(dataset_noise_val,args),
        batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=False),
    'deblurring': DataLoader(dataset_blur_val,sampler=create_sampler_val(dataset_blur_val,args),
        batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=False),
    'super_resolution': DataLoader(dataset_super_val,sampler=create_sampler_val(dataset_super_val,args),
        batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=False),
    'inpainting': DataLoader(dataset_inpaint_val,sampler=create_sampler_val(dataset_inpaint_val,args),
        batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=False),
    'demasking': DataLoader(dataset_demask_val,sampler=create_sampler_val(dataset_demask_val,args),
        batch_size=args.batch_size,
        num_workers=args.num_workers,
        pin_memory=args.pin_mem,
        drop_last=False),
