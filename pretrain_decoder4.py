...
from engine_decoder4 import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/scratch3/ven073/decoder4',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/scratch3/ven073/decoder4/log_dir',
...
def main(args):
    ...
    model=Model_Restoration_Decoder4(shared_encoder,decoder)
    model.to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        model_trained= train_one_epoch(model,data_loader_train,data_loader_val,device,optimizer,loss_scaler,epoch,log_writer,args)
        ...
        if args.output_dir and (epoch % 100 == 0 or epoch + 1 == args.epochs):
                ...
                }, f'/scratch3/ven073/decoder4/shared_encoder_{epoch+1}.pth')
